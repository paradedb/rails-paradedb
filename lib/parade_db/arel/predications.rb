...
module ParadeDB
  module Arel
    module Predications
      ...
      def pdb_match(term = nil)
        BUILDER.match(self, term)
      end

      def pdb_match_any(term = nil)
        BUILDER.match_any(self, term)
      end
      ...
      def pdb_phrase(text)
        BUILDER.phrase(self, text)
      end

      def pdb_term(term)
        BUILDER.term(self, term)
      end
      ...
      def pdb_near(proximity)
        BUILDER.near(self, proximity)
      end
