...
| `near(column, left_terms, right_terms, distance:, ordered: false, boost: nil, constant_score: nil)`                          | `column @@@ ('a' ## d ## 'b')` / `(pdb.prox_array('a', 'b') ## d ## 'c')`                                |
| `near(column, [ParadeDB.regex_term('a'), 'b'], ['c', ParadeDB.regex_term('d')], distance:, boost: nil, constant_score: nil)` | `column @@@ (pdb.prox_array(pdb.prox_regex('a'), 'b') ## d ## pdb.prox_array('c', pdb.prox_regex('d')))` |
